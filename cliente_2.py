        ...
        while True:
               ...
               # juego.blit(Jugador.Nave,(Jugador.posx,Jugador.posy))
                ...
                if keys[K_LEFT]:
                        ...
                        if Jugador2.rect.left > -1:
                                
                                Jugador2.rect.left -= Jugador2.velocidad_nave
                                posx_2 = Jugador2.rect.centerx
                                print(posx_2)
                                
                elif keys[K_RIGHT]:
                                
                                
                        if Jugador2.rect.right < 1350:
                                Jugador2.rect.right += Jugador2.velocidad_nave
                                posx_2 = Jugador2.rect.centerx
                                print(posx_2)
